...
class TestMainappSmoke(TestCase):
    def setUp(self) -> None:
        ...
        self.superuser = ShopUser.objects.create_superuser('administrator', 'administrator@geekshop.local', 'admin')

        self.user = ShopUser.objects.create_user('messi', 'messi@geekshop.local', 'messi10')

        self.user_with__first_name = ShopUser.objects.create_user('mason', 'mason@geekshop.local', 'mason7', first_name='Мэйсон')
    ...
    def test_user_login(self):
        ...
        self.client.login(username='messi', password='messi10')
        ...
        response = self.client.get('/')
        self.assertContains(response, 'messi', status_code=200)
        self.assertEqual(response.context['user'], self.user)
